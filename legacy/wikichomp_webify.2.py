...
req = urllib2.Request("http://en.wikipedia.org/wiki/%s" % term, \
...
#clean up vocab,  remove wikipedia wiki phrases
wikiwords = ['main page','contents','random article','isdn','recent changes','upload file','isbn','categories','featured content']
for each in wikiwords:
	while each in vocab:
		vocab.remove(each)
